...
TOKEN = "7552142478:AAGjydEn1fuxzD3ZSk_2kZRjI1XXk0qwshM"
...
def start_message(message):
    bot.send_message(message.chat.id, "Привет! Отправьте мне название лекарства, и я предоставлю вам информацию о нём.")
